...
const DoodleStage = ({ imageUrl, children }) => {
    if (!imageUrl) {
        return (
            <div className='flex-1 min-h-105 rounded-2xl border border-dashed border-neutral-800 bg-neutral-950/40 flex flex-col items-center justify-center gap-3 text-center px-6'>
                ...
                <p className='text-[11px] text-neutral-600 max-w-55'>
