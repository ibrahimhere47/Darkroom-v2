...
const GuideButton = () => {
    ...
    return (
        <Link to={`/guides/${toolId}`}>
            <div className='flex p-4 rounded-2xl -bg-linear-50 from-neutral-900 to-neutral-950 border border-neutral-800 text-neutral-200 w-full justify-self-center mt-4 mb-12'>
